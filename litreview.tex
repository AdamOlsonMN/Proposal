...
Broadly, this dissertation asks how the politics of congressional procedures and behaviors affected the creation and subsequent development of the American welfare state. Further, by incorporating new research as to what constitutes the American welfare state, this dissertation will be able to examine how individual programs are created \emph{and} persist vis-a-vie each other. The juxtaposition of the traditional American welfare state literature, hidden welfare literature, and also the congressional literature would drastically improve our understanding of these subjects individually but would also improve the way we view American policy making as well.  
